...
class FormAñadirCancion extends Formulario{
    ...
    protected function procesaFormulario(&$datos)
    {
        ...
        if (count($this->errores) === 0) {
            $cancion = new Cancion($idCancion, $nombreCancion, $genero, $nombreAlbum, $duracion, $rutaCancion, $rutaImagen);
            Usuario::subirCancion($cancion);
        }
    }
